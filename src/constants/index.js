...
export const PROJECTS = [{
    ...
    {
        title: "Ensemble Model Research for Deep Learning",
        image: project5,
        description: "Currently researching an ensemble approach integrating six models (InceptionV3, ViT_B16, DenseNet121, ResNet50, EfficientNetB0, MobileNetV3) to compare ensemble distillation versus mutual learning strategies.",
        technologies: ["Python", "TensorFlow", "Keras", "PyTorch", "Deep Learning", "Ensemble Learning"],
        links: []
    }
];
